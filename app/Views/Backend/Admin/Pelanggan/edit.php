            ...
            <div class="panel-body">
                ...
                <?= form_open('/admin/pelanggan/update/' . $pelanggan->pelanggan_id) ?>
                    <?= csrf_field() ?>                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="no_ktp" name="no_ktp" value="<?= old('no_ktp', $pelanggan->no_ktp ?? '') ?>" required pattern="[0-9]{16}" maxlength="16" minlength="16" title="Masukkan No KTP (16 digit angka, tanpa spasi atau karakter lain)">
                    </div>
