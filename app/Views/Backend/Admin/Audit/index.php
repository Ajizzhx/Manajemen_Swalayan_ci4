...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li><a href="<?= site_url('admin/audit-log') ?>">Log Audit</a></li>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-md-12">
                            <form action="<?= site_url('admin/audit-log') ?>" method="get" class="form-inline">
                                ...
                                <?php if (!empty($keyword) || !empty($start_date) || !empty($end_date)): ?>
                                    <a href="<?= site_url('admin/audit-log') ?>" class="btn btn-default">Reset</a>
                                <?php endif; ?>
                            </form>
                        </div>
                    </div>
